...
| consolearcade         | Console Arcade Systems                         | MAME - Current                    | MAME4droid Current **(Standalone)**,<br>Flycast,<br>Flycast **(Standalone)**,<br>Play! **(Standalone)**,<br>Dolphin **(Standalone)** | Depends      | See the specific _Console Arcade Systems_ section in the user guide |
...
| triforce              | Namco-Sega-Nintendo Triforce                   | Dolphin **(Standalone)**          |                                   | No           |                                      |
