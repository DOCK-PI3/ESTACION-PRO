# ESTACION-PRO Frontend - Building and advanced configuration
...
To build ESTACION-PRO with CEC support, enable the corresponding option, for example:
...
You can use ESTACION-PRO's scrapers to populate the gamelist.xml files, or manually update individual entries using the metadata editor. All of this is explained in the [User guide](USERGUIDE.md).
